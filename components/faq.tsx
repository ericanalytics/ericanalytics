                    ...
                    <div className="col-lg-10">
                        <Accordion defaultActiveKey="0">
                            ...
                            <Accordion.Item eventKey="6">
                                ...
                                <Accordion.Body>
                                    You can contact Eric Analytics through the website,{" "}
                                    ericanalytics.net to schedule a consultation. The{" "}
                                    <Link href="#contact" className="text-blue-600 underline">
                                        Get In Touch
                                    </Link>{" "}
                                    section provides details for reaching out to discuss how its Web Analytics
                                    and Google Analytics services can support your business growth.
                                </Accordion.Body>
                            </Accordion.Item>
                        </Accordion>
                    </div>
